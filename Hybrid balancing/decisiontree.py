...
print("Accuracy (Decision Tree with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (Decision Tree with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (Decision Tree with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (Decision Tree with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (Decision Tree with Chi-Square + SMOTE-Tomek):", support)
