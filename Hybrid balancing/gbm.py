...
# Train a GBM classifier on the selected features
...
print("Accuracy (GBM with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (GBM with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (GBM with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (GBM with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (GBM with Chi-Square + SMOTE-Tomek):", support)
