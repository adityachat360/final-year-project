...
print("Accuracy (XGBoost with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (XGBoost with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (XGBoost with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (XGBoost with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (XGBoost with Chi-Square + SMOTE-Tomek):", support)
