...
print("Accuracy (AdaBoost with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (AdaBoost with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (AdaBoost with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (AdaBoost with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (AdaBoost with Chi-Square + SMOTE-Tomek):", support)
