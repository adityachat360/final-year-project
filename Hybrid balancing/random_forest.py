...
print("Accuracy (Random Forest with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (Random Forest with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (Random Forest with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (Random Forest with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (Random Forest with Chi-Square + SMOTE-Tomek):", support)
