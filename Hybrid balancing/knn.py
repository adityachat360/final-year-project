...
print("Accuracy (KNN with Chi-Square + SMOTE-Tomek):", accuracy)
print("Precision (KNN with Chi-Square + SMOTE-Tomek):", precision)
print("Recall (KNN with Chi-Square + SMOTE-Tomek):", recall)
print("F1-Score (KNN with Chi-Square + SMOTE-Tomek):", f1_score)
print("Support (KNN with Chi-Square + SMOTE-Tomek):", support)
