...
dt_clf.fit(X_train_selected_backward_elimination, y_train_resampled)

# Make predictions on the test set using the model with selected features
y_pred = dt_clf.predict(X_test_selected_backward_elimination)
...
print("Accuracy (Decision Tree with Backward Elimination + SMOTE):", accuracy)
print("Precision (Decision Tree with Backward Elimination + SMOTE):", precision)
print("Recall (Decision Tree with Backward Elimination + SMOTE):", recall)
print("F1-Score (Decision Tree with Backward Elimination + SMOTE):", f1_score)
print("Support (Decision Tree with Backward Elimination + SMOTE):", support)
