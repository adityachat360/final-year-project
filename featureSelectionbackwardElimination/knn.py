...
knn_clf.fit(X_train_selected_backward_elimination, y_train_resampled)

# Make predictions on the test set using the model with selected features
y_pred = knn_clf.predict(X_test_selected_backward_elimination)
...
print("Accuracy (KNN with Backward Elimination + SMOTE):", accuracy)
print("Precision (KNN with Backward Elimination + SMOTE):", precision)
print("Recall (KNN with Backward Elimination + SMOTE):", recall)
print("F1-Score (KNN with Backward Elimination + SMOTE):", f1_score)
print("Support (KNN with Backward Elimination + SMOTE):", support)
