...
adaboost_clf.fit(X_train_selected_backward_elimination, y_train_resampled)

# Make predictions on the test set using the model with selected features
y_pred = adaboost_clf.predict(X_test_selected_backward_elimination)
...
print("Accuracy (AdaBoost with Backward Elimination + SMOTE):", accuracy)
print("Precision (AdaBoost with Backward Elimination + SMOTE):", precision)
print("Recall (AdaBoost with Backward Elimination + SMOTE):", recall)
print("F1-Score (AdaBoost with Backward Elimination + SMOTE):", f1_score)
print("Support (AdaBoost with Backward Elimination + SMOTE):", support)
