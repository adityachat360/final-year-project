...
nb_clf = GaussianNB()
nb_clf.fit(X_train_selected_backward_elimination, y_train_resampled)

# Make predictions on the test set using the model with selected features
y_pred = nb_clf.predict(X_test_selected_backward_elimination)
...
print("Accuracy (Naive Bayes with Backward Elimination + SMOTE):", accuracy)
print("Precision (Naive Bayes with Backward Elimination + SMOTE):", precision)
print("Recall (Naive Bayes with Backward Elimination + SMOTE):", recall)
print("F1-Score (Naive Bayes with Backward Elimination + SMOTE):", f1_score)
print("Support (Naive Bayes with Backward Elimination + SMOTE):", support)
