...
rf_clf.fit(X_train_selected_backward_elimination, y_train_resampled)

# Make predictions on the test set using the model with selected features
y_pred = rf_clf.predict(X_test_selected_backward_elimination)
...
print("Accuracy (Random Forest with Backward Elimination + SMOTE):", accuracy)
print("Precision (Random Forest with Backward Elimination + SMOTE):", precision)
print("Recall (Random Forest with Backward Elimination + SMOTE):", recall)
print("F1-Score (Random Forest with Backward Elimination + SMOTE):", f1_score)
print("Support (Random Forest with Backward Elimination + SMOTE):", support)
