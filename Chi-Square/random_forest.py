...
print("Accuracy (Random Forest with Chi-Square + SMOTE):", accuracy)
print("Precision (Random Forest with Chi-Square + SMOTE):", precision)
print("Recall (Random Forest with Chi-Square + SMOTE):", recall)
print("F1-Score (Random Forest with Chi-Square + SMOTE):", f1_score)
print("Support (Random Forest with Chi-Square + SMOTE):", support)
