...
print("Accuracy (KNN with Chi-Square + SMOTE):", accuracy)
print("Precision (KNN with Chi-Square + SMOTE):", precision)
print("Recall (KNN with Chi-Square + SMOTE):", recall)
print("F1-Score (KNN with Chi-Square + SMOTE):", f1_score)
print("Support (KNN with Chi-Square + SMOTE):", support)
