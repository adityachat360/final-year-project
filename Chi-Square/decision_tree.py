...
print("Accuracy (Decision Tree with Chi-Square + SMOTE):", accuracy)
print("Precision (Decision Tree with Chi-Square + SMOTE):", precision)
print("Recall (Decision Tree with Chi-Square + SMOTE):", recall)
print("F1-Score (Decision Tree with Chi-Square + SMOTE):", f1_score)
print("Support (Decision Tree with Chi-Square + SMOTE):", support)
