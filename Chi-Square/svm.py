...
print("Accuracy (SVM with Chi-Square + SMOTE):", accuracy)
print("Precision (SVM with Chi-Square + SMOTE):", precision)
print("Recall (SVM with Chi-Square + SMOTE):", recall)
print("F1-Score (SVM with Chi-Square + SMOTE):", f1_score)
print("Support (SVM with Chi-Square + SMOTE):", support)
