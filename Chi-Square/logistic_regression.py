...
lr_clf.fit(X_train_selected, y_train_resampled)
...
print("Accuracy (Logistic Regression with Chi-Square + SMOTE):", accuracy)
print("Precision (Logistic Regression with Chi-Square + SMOTE):", precision)
print("Recall (Logistic Regression with Chi-Square + SMOTE):", recall)
print("F1-Score (Logistic Regression with Chi-Square + SMOTE):", f1_score)
print("Support (Logistic Regression with Chi-Square + SMOTE):", support)
