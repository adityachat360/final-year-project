...
print("Accuracy (GBM with Chi-Square + SMOTE):", accuracy)
print("Precision (GBM with Chi-Square + SMOTE):", precision)
print("Recall (GBM with Chi-Square + SMOTE):", recall)
print("F1-Score (GBM with Chi-Square + SMOTE):", f1_score)
print("Support (GBM with Chi-Square + SMOTE):", support)
