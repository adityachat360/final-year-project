...
print("Accuracy (Naive Bayes with Chi-Square + SMOTE):", accuracy)
print("Precision (Naive Bayes with Chi-Square + SMOTE):", precision)
print("Recall (Naive Bayes with Chi-Square + SMOTE):", recall)
print("F1-Score (Naive Bayes with Chi-Square + SMOTE):", f1_score)
print("Support (Naive Bayes with Chi-Square + SMOTE):", support)
