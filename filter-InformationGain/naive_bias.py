...
print("Accuracy (Naive Bayes with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (Naive Bayes with Mutual Information Gain + SMOTE):", precision)
print("Recall (Naive Bayes with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (Naive Bayes with Mutual Information Gain + SMOTE):", f1_score)
print("Support (Naive Bayes with Mutual Information Gain + SMOTE):", support)
