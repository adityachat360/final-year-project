...
print("Accuracy (Random Forest with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (Random Forest with Mutual Information Gain + SMOTE):", precision)
print("Recall (Random Forest with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (Random Forest with Mutual Information Gain + SMOTE):", f1_score)
print("Support (Random Forest with Mutual Information Gain + SMOTE):", support)
