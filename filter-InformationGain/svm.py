...
print("Accuracy (SVM with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (SVM with Mutual Information Gain + SMOTE):", precision)
print("Recall (SVM with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (SVM with Mutual Information Gain + SMOTE):", f1_score)
print("Support (SVM with Mutual Information Gain + SMOTE):", support)
