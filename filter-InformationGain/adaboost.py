...
y_pred = adaboost_clf.predict(X_test_selected)
...
print("Accuracy (AdaBoost with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (AdaBoost with Mutual Information Gain + SMOTE):", precision)
print("Recall (AdaBoost with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (AdaBoost with Mutual Information Gain + SMOTE):", f1_score)
print("Support (AdaBoost with Mutual Information Gain + SMOTE):", support)
