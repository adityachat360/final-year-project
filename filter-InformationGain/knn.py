...
knn_clf.fit(X_train_selected, y_train_resampled)
...
print("Accuracy (KNN with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (KNN with Mutual Information Gain + SMOTE):", precision)
print("Recall (KNN with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (KNN with Mutual Information Gain + SMOTE):", f1_score)
print("Support (KNN with Mutual Information Gain + SMOTE):", support)
