...
print("Accuracy (XGBoost with Mutual Information Gain + SMOTE):", accuracy)
print("Precision (XGBoost with Mutual Information Gain + SMOTE):", precision)
print("Recall (XGBoost with Mutual Information Gain + SMOTE):", recall)
print("F1-Score (XGBoost with Mutual Information Gain + SMOTE):", f1_score)
print("Support (XGBoost with Mutual Information Gain + SMOTE):", support)
