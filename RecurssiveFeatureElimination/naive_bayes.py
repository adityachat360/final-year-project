...
print("Accuracy (Naive Bayes with SelectKBest + SMOTE):", accuracy)
print("Precision (Naive Bayes with SelectKBest + SMOTE):", precision)
print("Recall (Naive Bayes with SelectKBest + SMOTE):", recall)
print("F1-Score (Naive Bayes with SelectKBest + SMOTE):", f1_score)
print("Support (Naive Bayes with SelectKBest + SMOTE):", support)
