...
# Get selected feature indices and column names
selected_feature_indices = selector.get_support(indices=True)
selected_feature_names = X.columns[selected_feature_indices]

# Print selected feature names
print("Selected Features after Pearson Correlation:")
...
print("\nCross-Validation Scores (GBM with Pearson + SMOTE):", cv_scores_pearson)
...
print("\nAccuracy (GBM with Pearson + SMOTE):", accuracy_pearson)
